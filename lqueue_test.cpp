...
int main () {
  ...
  cout << "After 3 Pushs size: " << newLQ1->size() << endl;
  newLQ1->Display();
  cout << "The size is " << newLQ1->size() << endl;
  ...
  cout << "Source size: " << newLQ1->size() << " and Copied size: " << newLQ2->size() << endl;
  ...
  *newLQ3 = *newLQ1;
  ...
  cout << "size below should match. Location should not" << endl;
  cout << "Source size: " << newLQ1->size() << " and Assigned size: " << newLQ3->size() << endl;
  cout << "Source location: " << &newLQ1 << " and Assigned location: " << &newLQ3 << endl;
  cout << "End Test 3 - Assignment" << endl << endl;
  
  //Test 4 - Test Pop
  cout << "Test 4 - Pop" << endl;
  cout << "size before: " << newLQ1->size() << " ";
  newLQ1->Pop();
  newLQ1->Pop();
  newLQ1->Pop();
  cout << "size after: " << newLQ1->size() << endl;
